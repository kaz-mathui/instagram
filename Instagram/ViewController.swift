...
//  Instagram
//
//  Created by UserThree on 2019/03/06.
...
class ViewController: UIViewController {
    ...
    func setupTab() {
        ...
        let tabBarView = tabBarController.view!//ここの！も
        ...
        tabBarController.setAction({
            ...
            let imageViewController = self.storyboard?.instantiateViewController(withIdentifier: "ImageSelect")//nilが入る可能性がある
